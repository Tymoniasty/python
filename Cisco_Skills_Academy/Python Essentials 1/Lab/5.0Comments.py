...
hours = 2
hour_in_seconds = 3600 # number of seconds in 1 hour

print("Hours: ", hours) #printing the number of hours
print("Seconds in Hours: ", hours * hour_in_seconds) # printing the number of seconds in a given number of hours
