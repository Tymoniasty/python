...
'''
number_of_blocks = int(input("Please provide number of blocks: "))
height = 0
lower_level = 0
while number_of_blocks > lower_level:
  lower_level = height + 1
  number_of_blocks-=lower_level
  height += 1
else:
  print("The height of the piramid: ", height)
