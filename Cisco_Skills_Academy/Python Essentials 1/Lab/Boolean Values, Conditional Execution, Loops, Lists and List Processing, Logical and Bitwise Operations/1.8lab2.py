...
The people paid taxes, of course – their happiness had limits. The most important tax, called the Personal Income Tax 
(PIT for short) had to be paid once a year, and was evaluated using the following rule:
...
# Write the rest of your code here.
    ...
    reminder = income - 85528
    tax = 14839.02+(reminder*.32)
