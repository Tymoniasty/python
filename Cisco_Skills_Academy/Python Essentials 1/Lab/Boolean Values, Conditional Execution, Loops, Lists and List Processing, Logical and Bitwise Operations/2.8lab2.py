...
Hint: the most important part of the problem is how to transform 
Collatz's idea into a while loop – this is the key to success.
...
if c0 > 1:    
    while c0 != 1:
        if c0%2==0:
            ...
            cnew = 3 * c0 + 1
        steps+=1
        print("Value of c0:",int(c0))
        c0=cnew
    print("Number of steps: ",steps)
else:
    print("Wrong c0 value - please provide value higher than 1!")
    

# to stop printing '1' a 'cnew' is used for calculations on c0 instead:
    #  if c0%2==0:
    #         c0/=2
    #     else:
    #         c0=3*c0+1
    #     steps+=1
    #  print(c0) <= that way c0 was calculated and printed 